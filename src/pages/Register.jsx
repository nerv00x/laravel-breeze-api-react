      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form className="space-y-6" method="POST" onSubmit={handleRegister}>
          <div>
            ...
            <div className="mt-2">
              <input id="name" name="name" type="text" className={`block w-full border-0 rounded-md py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 ${errors.email && 'ring-red-500'}`} value={name} onChange={(e) => setName(e.target.value)}/>
            </div>
